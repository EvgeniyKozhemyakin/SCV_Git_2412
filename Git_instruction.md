...
2. Для того чтобы работать с файлами другого пользователя с удаленного репозитория,необходимо их скопировать в свой удаленный репозиторий, который мы создали. Для этого на сайте необходимо нажать `Fork` на странице польщователя чьи фацлы мы хотим открыть.
