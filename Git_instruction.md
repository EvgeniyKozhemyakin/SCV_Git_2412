...
* Для получение изменений на удаленном репозитории и слиянию с локальным  `git pull`
...
7. После того, как мы запушили наши файлы на удаленный репозиторий нам необходимо отправить их на репозиторий откуда мы делали копию.
