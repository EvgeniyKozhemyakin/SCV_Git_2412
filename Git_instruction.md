...
1. После того, как мы запушили наши файлы на удаленный репозиторий необходимо с помощью команды Pull request (в некоторых случаяъ кнопка появляется автоматически)отправить наши фалы на репозиторий откуда мы делали копию.
Для это нам необходимо перейти во вкладку Pull reuest и по инструкции слить наши файлы в удаленный репозиторий другого пользователя. Не забываем указать что необходимо слить файлы из нашей ветки `название нашей ветку` в ветку `main` другого пользователя.
<img src="images/Pullrequests.png" width = "850" >
